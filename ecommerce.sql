...
CREATE TABLE ModesLivraison (
    ...
    Nom NVARCHAR(100) NOT NULL,  -- Ex: Standard, Express, Retrait
    Description NVARCHAR(500),
...
('Retrait en magasin', 'Retrait gratuit dans nos points de vente partenaires', 0.00, 'Sous 24h après confirmation', 1);
...
('CMD-2025-00004', 2, 2, 3, 0.00, 280.00, 56.00, 336.00, 'Validée'),
